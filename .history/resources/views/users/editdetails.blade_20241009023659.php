          ...
          <form class="p-4 p-md-5 border rounded" action="{{route('update.details')}}" method="post">
            ...
            <div class="row form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="facebook" value="{{$userDetails->facebook}}"class="form-control" id="job-title" placeholder="Name">
              </div>

              <div class="form-group">
                <label for="job-title">Twitter</label>
                <input type="text" name="name" value="{{$userDetails->twitter}}"class="form-control" id="job-title" placeholder="Name">
              </div>

              <div class="form-group">
                <label for="job-title">Linkedin</label>
                <input type="text" name="name" value="{{$userDetails->linkedin}}"class="form-control" id="job-title" placeholder="Name">
              </div>
