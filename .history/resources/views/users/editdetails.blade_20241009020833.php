        ...
        <div class="col-lg-12">
          <form class="p-4 p-md-5 border rounded" action="post-job.php" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" id="job-title" placeholder="Product Designer">
            </div>
            ...
            <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="job_description" name="bio" id="" cols="30" rows="7" class="form-control" placeholder="Write Job Description..."></textarea>
                </div>
              </div>
