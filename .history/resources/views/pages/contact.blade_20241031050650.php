    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="block__87154 bg-white rounded">
            <blockquote>
              <p>&ldquoThanks to Jobee, I transitioned into a data science role with a top tech company. The platform made it easy to find positions that matched my skills in machine learning and big data.”&rdquo;</p>
            </blockquote>
            <div class="block__91147 d-flex align-items-center">
